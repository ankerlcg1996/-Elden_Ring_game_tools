...
`Source/` contains the internal shared code that was previously referenced from the outer workspace. It is now vendored inside `erdGameTools` so the project can be built and published as a self-contained repository subtree.
