...
public class GracePresetViewModel : BaseViewModel
{
    ...
    {
        string name = MsgBox.ShowInput("输入新预设名称：");
    ...
    private void RenameLoadout()
    {
        ...
        string newName = MsgBox.ShowInput("输入预设新名称：", SelectedLoadout.Name);
    ...
    private void AddGrace()
    {
        ...
        {
            MsgBox.Show("请先选择或创建预设，并选择要添加的赐福。");
            return;
        }
