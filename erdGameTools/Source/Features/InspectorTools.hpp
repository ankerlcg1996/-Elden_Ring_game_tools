...
struct InspectorSnapshot {
    ...
    std::vector<NpcMenuEntrySnapshot> npc_menus;
    std::string npc_menu_error;
};
...
private:
    ...
    fs::path loaded_npc_menu_path_;
    fs::file_time_type loaded_npc_menu_time_{};
